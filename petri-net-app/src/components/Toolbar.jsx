    ...
    <div className="toolbar-container flex flex-col p-2 bg-gray-50 border-b border-gray-200 shadow-sm" style={{ minHeight: '70px' }}>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50">
          ...
          />
          {/* Left-side drawer */}
          <div className="absolute top-0 left-0 bottom-0 w-3/4 max-w-sm bg-white shadow-2xl overflow-y-auto transform transition-transform duration-300 ease-in-out">
            <div className="p-5">
